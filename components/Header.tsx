...
export default function Header() {
    return (
        <header className="sticky top-0 z-50 px-12 py-6 flex items-center justify-between w-full">
            <div className="absolute top-0 w-full -mx-12 h-[200px]">
            ...
            <div className="hidden flex-1 grow md:block z-10 select-none">
