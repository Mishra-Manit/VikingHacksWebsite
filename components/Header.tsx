...
export default function Header() {
  return (
    <header className="flex flex-col xs:flex-row justify-between items-center w-full mt-3 border-b pb-3 md:px-32 sm:px-4 px-4 border-gray-700 gap-2">
      <Link href="/" className="flex space-x-1">
        <Image
          alt="header text"
          src="/vikinghacks_newlogo.png"
          className="sm:w-9 sm:h-9 w-8 h-8"
          width={476}
          height={536}
        />
        <h1 className="sm:text-3xl text-xl font-mono ml-2 tracking-tight pl-2">
          Viking Hacks
        </h1>
      </Link>
      <a
