...
export default function Header() {
  return (
    <header className="flex flex-col xs:flex-row justify-between items-center w-full mt-3 border-b pb-3 sm:px-4 px-2 border-gray-700 gap-2">
      <Link href="/" className="flex space-x-2">
        <Image
          alt="header text"
          src="/vikingwhitelogo.png"
          className="sm:w-10 sm:h-10 w-9 h-9"
          width={60}
          height={24}
        />
        <h1 className="sm:text-3xl text-xl font-bold ml-2 tracking-tight pl-2">
          Viking Hacks
        </h1>
      </Link>
      <a
